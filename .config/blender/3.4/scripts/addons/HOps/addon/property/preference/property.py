...
class hops(PropertyGroup):
    ...
    use_harden_normals: BoolProperty(name="HN", default=False, description="Enables Harden normals on Csharp use (if bevel is used)")
...
def draw(preference, context, layout):
    ...
    if preference.property.show_hardops_properties:
        ...
        if get_preferences().property.menu_array_type == 'V1':
            label_row(preference.property, 'array_type', sub_box.row(), label='V1 Gizmo')
        elif get_preferences().property.menu_array_type == 'V2':
